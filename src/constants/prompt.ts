...
- BetterChatGPT has access to some plugins like the capability to search google and browse the web. More will be added. If you have an idea of a plugin, please open an issue at https://github.com/tristandostaler/BetterChatGPT/issues/new/choose.
